...
import { Upload, Hash, FileText, AlertCircle } from 'lucide-react'
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        toast.dismiss(toastId)
        toast.error('Evidence recorded on blockchain but failed to save to database')
      ...
      toast.error(error.reason || error.message || 'Failed to register evidence')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                disabled={loading || !isConnected || hashingFile}
              ...
              >
                {loading ? 'Registering Evidence...' : 'Register Evidence on Blockchain'}
              </button>
              <button
                type="button"
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            ...
            <li>• Blockchain ensures immutable record of evidence registration</li>
          </ul>
        </div>
      </div>
    </Layout>
