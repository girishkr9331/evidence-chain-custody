        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">Evidence Chain</span>
            </div>
            <button
          ...
          <div className="p-4 border-t border-gray-200">
            ...
            {!isConnected ? (
              ...
              <div className="text-xs text-gray-500 mb-2">
                <p className="truncate">Wallet: {account?.slice(0, 6)}...{account?.slice(-4)}</p>
              </div>
            )}
            
            <button
              onClick={handleLogout}
              className="w-full flex items-center justify-center px-4 py-2 mt-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
            >
